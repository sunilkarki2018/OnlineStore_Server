...
namespace Ecommerce.WebAPI.Migrations
{
    ...
    [Migration("20231223095958_Create")]
            ...
            modelBuilder.Entity("Ecommerce.Core.src.Entities.Address", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e40c4866-194a-4350-bb41-bcbde62d08d3"),
                            City = "Cityville",
                            Country = "Countryland",
                            ...
                            UserId = new Guid("81a7fb9b-4377-4fe2-a1df-a51eb705f0ef")
                        },
                        new
                        {
                            Id = new Guid("6a5201f0-d3d5-4182-ad86-e8e336c69ce4"),
                            City = "Townsville",
                            Country = "Countryland",
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            HouseNumber = "456",
                            ...
                            Street = "Oak St",
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            UserId = new Guid("fcd852f8-3750-47d4-a543-424586098dae")
                        });
                });
            ...
            modelBuilder.Entity("Ecommerce.Core.src.Entities.Avatar", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c7e328dc-c647-4f3c-b2e3-e7389ee17e40"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Data = new byte[] { 4, 5, 6 },
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            UserId = new Guid("81a7fb9b-4377-4fe2-a1df-a51eb705f0ef")
                        ...
                        new
                        {
                            Id = new Guid("f682dd07-b308-4cf3-978e-c11501382158"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("Ecommerce.Core.src.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("75b7846e-18d6-4493-a528-80c5283cee98"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Image = "tshirts.jpg",
                            Name = "T-Shirts",
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        ...
                        new
                        {
                            Id = new Guid("680f59c7-1ba6-469d-a9fd-71453fefb2e5"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Image = "jeans.jpg",
                            Name = "Jeans",
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        ...
                        new
                        {
                            Id = new Guid("3be32f4e-493d-4ea8-ac87-894133202e63"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Image = "dresses.jpg",
                            Name = "Dresses",
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        ...
                        new
                        {
                            Id = new Guid("e187928a-e076-401e-a58d-d314c2830e6a"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Image = "footwear.jpg",
                            Name = "Footwear",
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        ...
                        new
                        {
                            Id = new Guid("5f59ad2c-913a-4741-9fb4-b11f5e0316e2"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("Ecommerce.Core.src.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ee8a8788-b529-4cb7-9f48-80bcd482c189"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Inventory = 100,
                            ProductLineId = new Guid("5b2cc5f5-474a-48a5-a546-dd9fb73c8d09"),
                            ProductSizeId = new Guid("d9f06780-c8db-4b1f-ad86-09b923c3722f"),
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = new Guid("5515aafc-680a-475b-8f90-9146e35511bc"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Inventory = 200,
                            ProductLineId = new Guid("5b2cc5f5-474a-48a5-a546-dd9fb73c8d09"),
                            ProductSizeId = new Guid("38b52562-538f-47ce-ae57-846e7d30be3f"),
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = new Guid("6e740567-0922-4b5c-82c5-3894cb7e75a9"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Inventory = 200,
                            ProductLineId = new Guid("5b2cc5f5-474a-48a5-a546-dd9fb73c8d09"),
                            ProductSizeId = new Guid("1aba3111-0d53-4789-8dff-c3dac5bd9b12"),
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = new Guid("8ce26fd6-9b9a-4050-a4f6-6dd243c1cd52"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Inventory = 100,
                            ProductLineId = new Guid("5b2cc5f5-474a-48a5-a546-dd9fb73c8d09"),
                            ProductSizeId = new Guid("d6c24717-7e2c-4490-949a-79e5870e0a12"),
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = new Guid("721530a8-d131-4aa0-86b8-d82de1376bf4"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Inventory = 100,
                            ProductLineId = new Guid("692f3a64-2715-4757-901c-fd52e6bb5be6"),
                            ProductSizeId = new Guid("d9f06780-c8db-4b1f-ad86-09b923c3722f"),
                        ...
                        new
                        {
                            Id = new Guid("b16daedf-4a48-454d-9960-7c0f1d59fd3e"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Inventory = 200,
                            ProductLineId = new Guid("692f3a64-2715-4757-901c-fd52e6bb5be6"),
                            ProductSizeId = new Guid("38b52562-538f-47ce-ae57-846e7d30be3f"),
                        ...
                        new
                        {
                            Id = new Guid("ff086aea-7647-4fc7-b292-39ec7a3fdddb"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Inventory = 200,
                            ProductLineId = new Guid("692f3a64-2715-4757-901c-fd52e6bb5be6"),
                            ProductSizeId = new Guid("1aba3111-0d53-4789-8dff-c3dac5bd9b12"),
                        ...
                        new
                        {
                            Id = new Guid("f550e2f4-1a35-41ac-899c-6bbfb0f1dcf9"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Inventory = 100,
                            ProductLineId = new Guid("692f3a64-2715-4757-901c-fd52e6bb5be6"),
                            ProductSizeId = new Guid("d6c24717-7e2c-4490-949a-79e5870e0a12"),
                        ...
                        new
                        {
                            Id = new Guid("e7905b30-c3a8-4754-ba14-ba9885e736fc"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Inventory = 100,
                            ProductLineId = new Guid("e0c385e8-5a48-4ad5-8e69-9c5aa1923481"),
                            ProductSizeId = new Guid("d9f06780-c8db-4b1f-ad86-09b923c3722f"),
                        ...
                        new
                        {
                            Id = new Guid("5645e3d1-c51a-4af6-adf8-09d54b36e02e"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Inventory = 200,
                            ProductLineId = new Guid("e0c385e8-5a48-4ad5-8e69-9c5aa1923481"),
                            ProductSizeId = new Guid("38b52562-538f-47ce-ae57-846e7d30be3f"),
                        ...
                        new
                        {
                            Id = new Guid("b123fc12-5c66-40d7-ac2a-da1f8944490f"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Inventory = 200,
                            ProductLineId = new Guid("e0c385e8-5a48-4ad5-8e69-9c5aa1923481"),
                            ProductSizeId = new Guid("1aba3111-0d53-4789-8dff-c3dac5bd9b12"),
                        ...
                        new
                        {
                            Id = new Guid("73260729-c2d7-4fa7-aaa7-642d4e2d643f"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Inventory = 100,
                            ProductLineId = new Guid("e0c385e8-5a48-4ad5-8e69-9c5aa1923481"),
                            ProductSizeId = new Guid("d6c24717-7e2c-4490-949a-79e5870e0a12"),
                        ...
                        new
                        {
                            Id = new Guid("1acad2c1-3940-4456-9d5e-b9fb7c2bd0fa"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Inventory = 100,
                            ProductLineId = new Guid("efb7215e-b0b4-4670-8e4e-1147856f09a0"),
                            ProductSizeId = new Guid("d9f06780-c8db-4b1f-ad86-09b923c3722f"),
                        ...
                        new
                        {
                            Id = new Guid("c84f0d5e-8e0a-46ff-91bb-5b0d28525fa2"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Inventory = 200,
                            ProductLineId = new Guid("efb7215e-b0b4-4670-8e4e-1147856f09a0"),
                            ProductSizeId = new Guid("38b52562-538f-47ce-ae57-846e7d30be3f"),
                        ...
                        new
                        {
                            Id = new Guid("5431cce6-b5b3-4c8e-8e1c-93129a050215"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Inventory = 200,
                            ProductLineId = new Guid("efb7215e-b0b4-4670-8e4e-1147856f09a0"),
                            ProductSizeId = new Guid("1aba3111-0d53-4789-8dff-c3dac5bd9b12"),
                        ...
                        new
                        {
                            Id = new Guid("4f455c51-eb27-48de-832a-5e86a4702d72"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Inventory = 100,
                            ProductLineId = new Guid("efb7215e-b0b4-4670-8e4e-1147856f09a0"),
                            ProductSizeId = new Guid("d6c24717-7e2c-4490-949a-79e5870e0a12"),
                        ...
                        new
                        {
                            Id = new Guid("6090875e-11df-46e1-adb6-4c499912bbde"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Inventory = 100,
                            ProductLineId = new Guid("efb7215e-b0b4-4670-8e4e-1147856f09a0"),
                            ProductSizeId = new Guid("d9f06780-c8db-4b1f-ad86-09b923c3722f"),
                        ...
                        new
                        {
                            Id = new Guid("e41ec8f2-b38b-494b-b41a-78acd989eb7c"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Inventory = 200,
                            ProductLineId = new Guid("efb7215e-b0b4-4670-8e4e-1147856f09a0"),
                            ProductSizeId = new Guid("38b52562-538f-47ce-ae57-846e7d30be3f"),
                        ...
                        new
                        {
                            Id = new Guid("40be79d4-2f29-4919-9473-cfca2c31539f"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Inventory = 200,
                            ProductLineId = new Guid("efb7215e-b0b4-4670-8e4e-1147856f09a0"),
                            ProductSizeId = new Guid("1aba3111-0d53-4789-8dff-c3dac5bd9b12"),
                        ...
                        new
                        {
                            Id = new Guid("fed5c01b-79a6-46cf-accc-bc4f426059d7"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Inventory = 100,
                            ProductLineId = new Guid("efb7215e-b0b4-4670-8e4e-1147856f09a0"),
                            ProductSizeId = new Guid("d6c24717-7e2c-4490-949a-79e5870e0a12"),
            ...
            modelBuilder.Entity("Ecommerce.Core.src.Entities.ProductLine", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("5b2cc5f5-474a-48a5-a546-dd9fb73c8d09"),
                            CategoryId = new Guid("75b7846e-18d6-4493-a528-80c5283cee98"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = new Guid("692f3a64-2715-4757-901c-fd52e6bb5be6"),
                            CategoryId = new Guid("680f59c7-1ba6-469d-a9fd-71453fefb2e5"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = new Guid("e0c385e8-5a48-4ad5-8e69-9c5aa1923481"),
                            CategoryId = new Guid("3be32f4e-493d-4ea8-ac87-894133202e63"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = new Guid("efb7215e-b0b4-4670-8e4e-1147856f09a0"),
                            CategoryId = new Guid("e187928a-e076-401e-a58d-d314c2830e6a"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = new Guid("c9e01bc8-8637-4884-954c-7d894ebe01e8"),
                            CategoryId = new Guid("5f59ad2c-913a-4741-9fb4-b11f5e0316e2"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("Ecommerce.Core.src.Entities.ProductSize", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d9f06780-c8db-4b1f-ad86-09b923c3722f"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Value = 32
                        },
                        new
                        {
                            Id = new Guid("38b52562-538f-47ce-ae57-846e7d30be3f"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Value = 34
                        },
                        new
                        {
                            Id = new Guid("1aba3111-0d53-4789-8dff-c3dac5bd9b12"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Value = 36
                        },
                        new
                        {
                            Id = new Guid("d6c24717-7e2c-4490-949a-79e5870e0a12"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Value = 38
                        });
            ...
            modelBuilder.Entity("Ecommerce.Core.src.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("81a7fb9b-4377-4fe2-a1df-a51eb705f0ef"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "admin@mail.com",
                            FirstName = "JohnAdmin",
                            LastName = "Doe",
                            Password = "49d3ef32bc4a4116033fb6479b2d28f05c37f16c8617c83663fe4439f6b46877",
                            Role = Role.Admin,
                            Salt = new byte[] { 222, 238, 105, 1, 210, 35, 10, 72, 143, 56, 168, 46, 73, 37, 248, 218, 141, 40, 33, 72, 64, 106, 109, 195, 108, 10, 169, 125, 133, 157, 90, 172, 173, 78, 29, 239, 193, 13, 241, 180, 228, 100, 123, 156, 96, 41, 115, 22, 52, 173, 96, 148, 93, 100, 242, 253, 118, 201, 101, 223, 219, 236, 4, 55 },
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = new Guid("fcd852f8-3750-47d4-a543-424586098dae"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "customer@mail.com",
                            FirstName = "Jane",
                            LastName = "Doe",
                            Password = "3ba3bbf6fdef9042364db1de1ad14947b7411217422291d12cd2a5e6482e0883",
                            Role = Role.Customer,
                            Salt = new byte[] { 108, 50, 170, 57, 161, 242, 136, 177, 179, 42, 136, 136, 64, 97, 113, 188, 86, 178, 195, 112, 13, 110, 117, 19, 11, 226, 219, 158, 43, 45, 69, 9, 98, 0, 117, 62, 201, 96, 149, 48, 158, 131, 226, 37, 134, 152, 215, 241, 48, 78, 206, 145, 101, 119, 189, 90, 89, 94, 35, 101, 222, 184, 192, 116 },
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        });
                });
